        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18" style="color: #FFA500;">Client Profile</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('/client/dashboard') }}" style="color: #FFC107;">Dashboard</a></li>
                            <li class="breadcrumb-item active" style="color: #FFA500;">Profile</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3">
                                            <img src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="Client Image" class="img-fluid rounded-circle d-block border border-3" style="border-color: #FFC107;">
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3 text-center">
                                    <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="Profile Image" class="rounded-circle p-1 bg-primary" style="width: 110px; border: 2px solid #FFA500;">
                                </div>
