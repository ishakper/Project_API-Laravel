                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Sign in to continue to MyWorld.</p>
                                </div>
    ...
    <div class="mb-3">
        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">Log In</button>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> IshackPer   . Crafted with <i class="mdi mdi-heart text-danger"></i> by IshakHadiPernama</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mt-4 pt-3 pb-5">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3 mb-4">
                                    <h5 class="font-size-18 text-white">IshakHadiPernama
                                    </h5>
                    ...
                    <div class="testi-contain text-white">
                        ...
                        <div class="mt-4 pt-3 pb-5">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3 mb-4">
                                    <h5 class="font-size-18 text-white">Jurusan Bisnis & Informatika
                                    </h5>
                        ...
                        <div class="mt-4 pt-3 pb-5">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-1 ms-3 mb-4">
                                    <h5 class="font-size-18 text-white">IsHakPer</h5>
